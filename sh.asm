...
runcmd(struct cmd *cmd)
{
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      71:	6a 02                	push   $0x2
      73:	e8 a4 0f 00 00       	call   101c <printf>
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      c4:	6a 02                	push   $0x2
      c6:	e8 51 0f 00 00       	call   101c <printf>
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     ...
     256:	68 0c 14 00 00       	push   $0x140c
     25b:	6a 02                	push   $0x2
     25d:	e8 ba 0d 00 00       	call   101c <printf>
     ...
     2c8:	eb 1b                	jmp    2e5 <main+0x44>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     2cd:	6a 02                	push   $0x2
     2cf:	68 0f 14 00 00       	push   $0x140f
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     2ea:	a0 80 19 00 00       	mov    0x1980,%al
     2ef:	3c 63                	cmp    $0x63,%al
     2f1:	75 57                	jne    34a <main+0xa9>
     2f3:	a0 81 19 00 00       	mov    0x1981,%al
     2f8:	3c 64                	cmp    $0x64,%al
     2fa:	75 4e                	jne    34a <main+0xa9>
     2fc:	a0 82 19 00 00       	mov    0x1982,%al
     ...
     308:	68 80 19 00 00       	push   $0x1980
     30d:	e8 d5 09 00 00       	call   ce7 <strlen>
     312:	83 c4 10             	add    $0x10,%esp
     315:	48                   	dec    %eax
     316:	c6 80 80 19 00 00 00 	movb   $0x0,0x1980(%eax)
      if(chdir(buf+3) < 0)
     31d:	83 ec 0c             	sub    $0xc,%esp
     320:	68 83 19 00 00       	push   $0x1983
     ...
     334:	68 83 19 00 00       	push   $0x1983
     339:	68 17 14 00 00       	push   $0x1417
     33e:	6a 02                	push   $0x2
     340:	e8 d7 0c 00 00       	call   101c <printf>
    ...
    if(fork1() == 0)
     ...
     356:	68 80 19 00 00       	push   $0x1980
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     377:	6a 64                	push   $0x64
     379:	68 80 19 00 00       	push   $0x1980
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     39f:	68 25 14 00 00       	push   $0x1425
     3a4:	6a 02                	push   $0x2
     3a6:	e8 71 0c 00 00       	call   101c <printf>
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     3ca:	68 29 14 00 00       	push   $0x1429
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3e5:	6a 54                	push   $0x54
     3e7:	e8 fb 0e 00 00       	call   12e7 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     41b:	6a 18                	push   $0x18
     41d:	e8 c5 0e 00 00       	call   12e7 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     47e:	6a 0c                	push   $0xc
     480:	e8 62 0e 00 00       	call   12e7 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4c6:	6a 0c                	push   $0xc
     4c8:	e8 1a 0e 00 00       	call   12e7 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     50e:	6a 08                	push   $0x8
     510:	e8 d2 0d 00 00       	call   12e7 <malloc>
     ...
     554:	ff 45 f4             	incl   -0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     56a:	50                   	push   %eax
     56b:	68 44 19 00 00       	push   $0x1944
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 44 19 00 00       	push   $0x1944
     ...
     62a:	50                   	push   %eax
     62b:	68 4c 19 00 00       	push   $0x194c
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     665:	50                   	push   %eax
     666:	68 44 19 00 00       	push   $0x1944
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6aa:	50                   	push   %eax
     6ab:	68 44 19 00 00       	push   $0x1944
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     72c:	68 2e 14 00 00       	push   $0x142e
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     74e:	50                   	push   %eax
     74f:	68 2f 14 00 00       	push   $0x142f
     754:	6a 02                	push   $0x2
     756:	e8 c1 08 00 00       	call   101c <printf>
     75b:	83 c4 10             	add    $0x10,%esp
    panic("syntax");
     75e:	83 ec 0c             	sub    $0xc,%esp
     761:	68 3e 14 00 00       	push   $0x143e
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     7c6:	68 45 14 00 00       	push   $0x1445
  ...
  if(peek(ps, es, ";")){
     ...
     7e0:	68 47 14 00 00       	push   $0x1447
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     84e:	68 49 14 00 00       	push   $0x1449
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     8dd:	68 4b 14 00 00       	push   $0x144b
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     963:	68 68 14 00 00       	push   $0x1468
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     98c:	68 6b 14 00 00       	push   $0x146b
    ...
    panic("parseblock");
     ...
     9a6:	68 6d 14 00 00       	push   $0x146d
  ...
  if(!peek(ps, es, ")"))
     ...
     9dc:	68 78 14 00 00       	push   $0x1478
    ...
    panic("syntax - missing )");
     ...
     9f6:	68 7a 14 00 00       	push   $0x147a
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     a3a:	68 6b 14 00 00       	push   $0x146b
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ac5:	68 3e 14 00 00       	push   $0x143e
    ...
    if(argc >= MAXARGS)
     ...
     afb:	68 8d 14 00 00       	push   $0x148d
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     b22:	68 9b 14 00 00       	push   $0x149b
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     b85:	8b 04 85 a0 14 00 00 	mov    0x14a0(,%eax,4),%eax
     b8c:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     fbc:	8a 80 54 19 00 00    	mov    0x1954(%eax),%al
...
printf(int fd, char *fmt, ...)
{
  ...
  state = 0;
    1022:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    1029:	8d 45 0c             	lea    0xc(%ebp),%eax
    102c:	83 c0 04             	add    $0x4,%eax
    102f:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    1032:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    1039:	e9 54 01 00 00       	jmp    1192 <printf+0x176>
    c = fmt[i] & 0xff;
    103e:	8b 55 0c             	mov    0xc(%ebp),%edx
    1041:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1044:	01 d0                	add    %edx,%eax
    1046:	8a 00                	mov    (%eax),%al
    1048:	0f be c0             	movsbl %al,%eax
    104b:	25 ff 00 00 00       	and    $0xff,%eax
    1050:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    1053:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1057:	75 2c                	jne    1085 <printf+0x69>
      if(c == '%'){
    1059:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    105d:	75 0c                	jne    106b <printf+0x4f>
        state = '%';
    105f:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    1066:	e9 24 01 00 00       	jmp    118f <printf+0x173>
      } else {
        putc(fd, c);
    ...
    1078:	e8 cd fe ff ff       	call   f4a <putc>
    107d:	83 c4 10             	add    $0x10,%esp
    1080:	e9 0a 01 00 00       	jmp    118f <printf+0x173>
      }
    } else if(state == '%'){
    1085:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    1089:	0f 85 00 01 00 00    	jne    118f <printf+0x173>
      if(c == 'd'){
    108f:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    1093:	75 1e                	jne    10b3 <printf+0x97>
        printint(fd, *ap, 10, 1);
    1095:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1098:	8b 00                	mov    (%eax),%eax
    109a:	6a 01                	push   $0x1
    109c:	6a 0a                	push   $0xa
    109e:	50                   	push   %eax
    109f:	ff 75 08             	pushl  0x8(%ebp)
    10a2:	e8 c5 fe ff ff       	call   f6c <printint>
    10a7:	83 c4 10             	add    $0x10,%esp
        ap++;
    10aa:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    10ae:	e9 d5 00 00 00       	jmp    1188 <printf+0x16c>
      } else if(c == 'x' || c == 'p'){
    10b3:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    10b7:	74 06                	je     10bf <printf+0xa3>
    10b9:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    10bd:	75 1e                	jne    10dd <printf+0xc1>
        printint(fd, *ap, 16, 0);
    10bf:	8b 45 e8             	mov    -0x18(%ebp),%eax
    10c2:	8b 00                	mov    (%eax),%eax
    10c4:	6a 00                	push   $0x0
    10c6:	6a 10                	push   $0x10
    10c8:	50                   	push   %eax
    10c9:	ff 75 08             	pushl  0x8(%ebp)
    10cc:	e8 9b fe ff ff       	call   f6c <printint>
    10d1:	83 c4 10             	add    $0x10,%esp
        ap++;
    10d4:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    10d8:	e9 ab 00 00 00       	jmp    1188 <printf+0x16c>
      } else if(c == 's'){
    10dd:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    10e1:	75 40                	jne    1123 <printf+0x107>
        s = (char*)*ap;
    ...
    10f3:	75 07                	jne    10fc <printf+0xe0>
          s = "(null)";
    10f5:	c7 45 f4 b8 14 00 00 	movl   $0x14b8,-0xc(%ebp)
        while(*s != 0){
    10fc:	eb 1a                	jmp    1118 <printf+0xfc>
          putc(fd, *s);
    10fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1101:	8a 00                	mov    (%eax),%al
    1103:	0f be c0             	movsbl %al,%eax
    1106:	83 ec 08             	sub    $0x8,%esp
    1109:	50                   	push   %eax
    110a:	ff 75 08             	pushl  0x8(%ebp)
    110d:	e8 38 fe ff ff       	call   f4a <putc>
    1112:	83 c4 10             	add    $0x10,%esp
          s++;
    1115:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    111f:	75 dd                	jne    10fe <printf+0xe2>
    1121:	eb 65                	jmp    1188 <printf+0x16c>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    1123:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    1127:	75 1d                	jne    1146 <printf+0x12a>
        putc(fd, *ap);
    1129:	8b 45 e8             	mov    -0x18(%ebp),%eax
    112c:	8b 00                	mov    (%eax),%eax
    112e:	0f be c0             	movsbl %al,%eax
    1131:	83 ec 08             	sub    $0x8,%esp
    1134:	50                   	push   %eax
    1135:	ff 75 08             	pushl  0x8(%ebp)
    1138:	e8 0d fe ff ff       	call   f4a <putc>
    113d:	83 c4 10             	add    $0x10,%esp
        ap++;
    1140:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1144:	eb 42                	jmp    1188 <printf+0x16c>
      } else if(c == '%'){
    1146:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    114a:	75 17                	jne    1163 <printf+0x147>
        putc(fd, c);
    114c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    114f:	0f be c0             	movsbl %al,%eax
    1152:	83 ec 08             	sub    $0x8,%esp
    1155:	50                   	push   %eax
    1156:	ff 75 08             	pushl  0x8(%ebp)
    1159:	e8 ec fd ff ff       	call   f4a <putc>
    115e:	83 c4 10             	add    $0x10,%esp
    1161:	eb 25                	jmp    1188 <printf+0x16c>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	6a 25                	push   $0x25
    1168:	ff 75 08             	pushl  0x8(%ebp)
    116b:	e8 da fd ff ff       	call   f4a <putc>
    1170:	83 c4 10             	add    $0x10,%esp
        putc(fd, c);
    1173:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1176:	0f be c0             	movsbl %al,%eax
    1179:	83 ec 08             	sub    $0x8,%esp
    117c:	50                   	push   %eax
    117d:	ff 75 08             	pushl  0x8(%ebp)
    1180:	e8 c5 fd ff ff       	call   f4a <putc>
    1185:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
    1188:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    118f:	ff 45 f0             	incl   -0x10(%ebp)
    1192:	8b 55 0c             	mov    0xc(%ebp),%edx
    1195:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1198:	01 d0                	add    %edx,%eax
    119a:	8a 00                	mov    (%eax),%al
    119c:	84 c0                	test   %al,%al
    119e:	0f 85 9a fe ff ff    	jne    103e <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    ...
    11af:	83 e8 08             	sub    $0x8,%eax
    11b2:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11b5:	a1 ec 19 00 00       	mov    0x19ec,%eax
    11ba:	89 45 fc             	mov    %eax,-0x4(%ebp)
    11bd:	eb 24                	jmp    11e3 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11bf:	8b 45 fc             	mov    -0x4(%ebp),%eax
    11c2:	8b 00                	mov    (%eax),%eax
    11c4:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    11c7:	77 12                	ja     11db <free+0x35>
    11c9:	8b 45 f8             	mov    -0x8(%ebp),%eax
    11cc:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    11cf:	77 24                	ja     11f5 <free+0x4f>
    11d1:	8b 45 fc             	mov    -0x4(%ebp),%eax
    11d4:	8b 00                	mov    (%eax),%eax
    11d6:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    11d9:	77 1a                	ja     11f5 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    121e:	01 c2                	add    %eax,%edx
    1220:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1223:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
    1226:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1229:	8b 00                	mov    (%eax),%eax
    122b:	8b 10                	mov    (%eax),%edx
    122d:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1230:	89 10                	mov    %edx,(%eax)
    1232:	eb 0a                	jmp    123e <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    1234:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1237:	8b 10                	mov    (%eax),%edx
  ...
  if(p + p->s.size == bp){
    ...
    1250:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    1253:	75 20                	jne    1275 <free+0xcf>
    p->s.size += bp->s.size;
    1255:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1258:	8b 50 04             	mov    0x4(%eax),%edx
    ...
    1271:	89 10                	mov    %edx,(%eax)
    1273:	eb 08                	jmp    127d <free+0xd7>
  } else
    p->s.ptr = bp;
    1275:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1278:	8b 55 f8             	mov    -0x8(%ebp),%edx
    127b:	89 10                	mov    %edx,(%eax)
  freep = p;
    127d:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1280:	a3 ec 19 00 00       	mov    %eax,0x19ec
}
    1285:	c9                   	leave  
    1286:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12a6:	50                   	push   %eax
    12a7:	e8 76 fc ff ff       	call   f22 <sbrk>
  ...
  free((void*)(hp + 1));
    ...
    12d7:	50                   	push   %eax
    12d8:	e8 c9 fe ff ff       	call   11a6 <free>
    12dd:	83 c4 10             	add    $0x10,%esp
  return freep;
    12e0:	a1 ec 19 00 00       	mov    0x19ec,%eax
}
    12e5:	c9                   	leave  
    12e6:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    12fa:	a1 ec 19 00 00       	mov    0x19ec,%eax
    12ff:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1302:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1306:	75 23                	jne    132b <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
    1308:	c7 45 f0 e4 19 00 00 	movl   $0x19e4,-0x10(%ebp)
    130f:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1312:	a3 ec 19 00 00       	mov    %eax,0x19ec
    1317:	a1 ec 19 00 00       	mov    0x19ec,%eax
    131c:	a3 e4 19 00 00       	mov    %eax,0x19e4
    base.s.size = 0;
    1321:	c7 05 e8 19 00 00 00 	movl   $0x0,0x19e8
    1328:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1344:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    ...
    137e:	a3 ec 19 00 00       	mov    %eax,0x19ec
      return (void*)(p + 1);
    ...
    if(p == freep)
    138b:	a1 ec 19 00 00       	mov    0x19ec,%eax
